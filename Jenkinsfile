...
node {
  ...
  sh "rm -rf /yolo/swag/*" // TODO: just precautionary, remove soon
  // Checkout the source code.
  checkout scm
  sh "mkdir -p /yolo/swag/${JOB_NAME}/${BUILD_NUMBER}"
  sh "cp -rf ${env.WORKSPACE}/* /yolo/swag/${JOB_NAME}/${BUILD_NUMBER}/"

  env.GOPATH = "/yolo/swag/${JOB_NAME}/${BUILD_NUMBER}"
  env.ROOT = "${env.GOPATH}/${root_path}"
